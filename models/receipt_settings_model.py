...
class ScanSuccessSoundRule:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "name": self.name,
            "sound_path": make_project_relative_path(self.sound_path),
    ...
    def from_dict(cls, payload: dict[str, Any] | None) -> "ScanSuccessSoundRule":
        ...
        return cls(
            ...
            sound_path=make_project_relative_path(data.get("sound_path", "")),
...
class ReceiptSettings:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "qr_scan_success_sound_path": make_project_relative_path(self.qr_scan_success_sound_path),
    ...
    def from_dict(cls, payload: dict[str, Any] | None) -> "ReceiptSettings":
        ...
        return cls(
            ...
            qr_scan_success_sound_path=make_project_relative_path(data.get("qr_scan_success_sound_path", "")),
